...
public class MovieTicketPriceCalculator {
     ...
     */
    public MovieTicketPriceCalculator(final LocalTime startMatineeTime, final LocalTime endMatineeTime, final int maxChildAge, final int minSeniorAge) {
        this.startMatineeTime = Objects.requireNonNull(startMatineeTime, "matinee start time cannot be null");
        this.endMatineeTime = Objects.requireNonNull(endMatineeTime, "matinee end time cannot be null");
        this.maxChildAge = maxChildAge;
        this.minSeniorAge = minSeniorAge;

        if (startMatineeTime.isAfter(endMatineeTime)) {
            throw new IllegalArgumentException("matinee start time cannot come after end time");
        }
    }
     ...
     */
    public int computePrice(final LocalTime scheduledTime, final int age) {
